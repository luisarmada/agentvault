...
riot.mount('.duelist', {
    logopath: "public/images/valorant/logo_transparent.png",
    roles: [
        {roleimg: "public/images/valorant/DuelistClassSymbol.webp", curr: true},
        {roleimg: "public/images/valorant/InitiatorsClassSymbol.webp", name: " initiators"},
        {roleimg: "public/images/valorant/SentinelClassSymbol.webp", name: "sentinels"},
        {roleimg: "public/images/valorant/ControllerClassSymbol.webp", name: "controllers"}
    ]
})
...
riot.mount('.initiator', {
    logopath: "public/images/valorant/logo_transparent.png",
    roles: [
        {roleimg: "public/images/valorant/DuelistClassSymbol.webp", name: "duelists"},
        {roleimg: "public/images/valorant/InitiatorsClassSymbol.webp", curr: true},
        {roleimg: "public/images/valorant/SentinelClassSymbol.webp", name: "sentinels"},
        {roleimg: "public/images/valorant/ControllerClassSymbol.webp", name: "controllers"}
    ]
})
...
riot.mount('.sentinel', {
    ...
    roles: [
        {roleimg: "public/images/valorant/DuelistClassSymbol.webp", name: "duelists"},
        {roleimg: "public/images/valorant/InitiatorsClassSymbol.webp", name: "initiators"},
        {roleimg: "public/images/valorant/SentinelClassSymbol.webp", curr: true},
        {roleimg: "public/images/valorant/ControllerClassSymbol.webp", name: "controllers"}
    ]
})
...
riot.mount('.controller', {
    ...
    roles: [
        ...
        {roleimg: "public/images/valorant/InitiatorsClassSymbol.webp", name: "initiators"},
        {roleimg: "public/images/valorant/SentinelClassSymbol.webp", name: "sentinels"},
        {roleimg: "public/images/valorant/ControllerClassSymbol.webp", curr: true}
    ]
}) 
...
riot.mount('#Jett', { name: "JETT", namesize: "100",
    ...
    img_fpath: "public/images/valorant/jett/",
    role: "0",
...
riot.mount('#Phoenix', { name: "PHOENIX", namesize: "65",
    ...
    img_fpath: "public/images/valorant/phoenix/",
...
riot.mount('#Raze', { name: "RAZE", namesize: "95",
    ...
    img_fpath: "public/images/valorant/raze/",
...
riot.mount('#Reyna', { name: "REYNA", namesize: "80",
    ...
    img_fpath: "public/images/valorant/reyna/",
...
riot.mount('#Yoru', { name: "YORU", namesize: "90",
    ...
    img_fpath: "public/images/valorant/yoru/",
...
riot.mount('#Neon', { name: "NEON", namesize: "90",
    ...
    img_fpath: "public/images/valorant/neon/",
...
riot.mount('#Iso', { name: "ISO", namesize: "90",
    ...
    img_fpath: "public/images/valorant/iso/",
...
riot.mount('#Viper', { name: "VIPER", namesize: "80",
    ...
    img_fpath: "public/images/valorant/viper/",
...
riot.mount('#Brimstone', { name: "BRIMSTONE", namesize: "47",
    ...
    img_fpath: "public/images/valorant/brimstone/",
...
riot.mount('#Omen', { name: "OMEN", namesize: "90",
    ...
    img_fpath: "public/images/valorant/omen/",
...
riot.mount('#Astra', { name: "ASTRA", namesize: "80",
    ...
    img_fpath: "public/images/valorant/astra/",
...
riot.mount('#Harbor', { name: "HARBOR", namesize: "70",
    ...
    img_fpath: "public/images/valorant/harbor/",
...
riot.mount('#Clove', { name: "CLOVE", namesize: "80",
    ...
    img_fpath: "public/images/valorant/clove/",
...
riot.mount('#Sova', { name: "SOVA", namesize: "95",
    ...
    img_fpath: "public/images/valorant/sova/",
...
riot.mount('#Breach', { name: "BREACH", namesize: "69",
    ...
    img_fpath: "public/images/valorant/breach/",
...
riot.mount('#Skye', { name: "SKYE", namesize: "95",
    ...
    img_fpath: "public/images/valorant/skye/",
...
riot.mount('#KAYO', { name: "KAY/O", namesize: "80",
    ...
    img_fpath: "public/images/valorant/kayo/",
...
riot.mount('#Fade', { name: "FADE", namesize: "100",
    ...
    img_fpath: "public/images/valorant/fade/",
...
riot.mount('#Gekko', { name: "GEKKO", namesize: "85",
    ...
    img_fpath: "public/images/valorant/gekko/",
...
riot.mount('#Sage', { name: "SAGE", namesize: "95",
    ...
    img_fpath: "public/images/valorant/sage/",
...
riot.mount('#Cypher', { name: "CYPHER", namesize: "70",
    ...
    img_fpath: "public/images/valorant/cypher/",
...
riot.mount('#Killjoy', { name: "KILLJOY", namesize: "70",
    ...
    img_fpath: "public/images/valorant/killjoy/",
...
riot.mount('#Chamber', { name: "CHAMBER", namesize: "55",
    ...
    img_fpath: "public/images/valorant/chamber/",
...
riot.mount('#Deadlock', { name: "DEADLOCK", namesize: "55",
    bgfromcol: "185,185,185", bgtocol: "19,19,25",
    img_fpath: "public/images/valorant/deadlock/",
